...
The category takeover contains all filings implying the engagement of the reporting firm into a takeover process of the issuing firms. This involves merger agreements, tender offers and hostile bids with merger agreements being the most and hostile bids the least reported. Therefore, around 50\% of the filings were submitted with the purpose of any kind of a takeover process. In comparison to weak firms, more than double the Schedule 13(D)'s were filed by strong firms, representing 26\% of the takeovers. On the other hand, 37\% of the filings with the acquirer being the target were filed by weak firms compared to only 6\% by strong firms. They acquired the shares to compensate shareholders with stock of the issuing firm. This is one of the two purposes were weak firms had substantially more filings than strong firms. 
...
\section{Identifying the Corporate Investor prior to the Schedule 13(D) Filing}
In order to analyze the third hypothesis, which states that abnormal returns, triggered by activist minority acquisitions, can be explained by the financial condition of the investor, measurements of financial condition have to be established. The general financial condition is determined by the financial analysis of characteristics such as profitability, liquidity, solvency and operational performance. To characterize the investors to that, Piotroskis F-Score is used as a measurement of general firm strength, the Whited-Wu- and KZ-Index relate to solvency and identify financially constraint firms and Altman's Z-Score represents a measurement on how distressed firms are. To give further insight of the acquiring firm's financial condition, other general measurements of fundamental analysis are listed. 

Table II represents the summary statistics of these measurements. In order to show how the sample firms compare to their respective control samples, their means (medians) are shown side-by-side. Columns (1) and (2) present the statistics for the investing firm and their control group, respectively. They also present significance levels for tests for difference between sample and control firm's means and medians. For all tests, the t-statistics are for difference in means, assuming unequal variances between sample. % What test for medians 

Table II starts with Panel A presenting the principal measurements underlying this thesis with regards to a firm's financial condition 
	\footnote{All measurements are winsorized at the 1\% and 99\% levels so that extreme values are replaced by the respective percenticles. This enables a presentation of more meaningful mean statistics \citep{Klein2009}.}. 
For example, \emph{BCG} noted in a study of 2010, many of that year's acquisitions would involve a financially strong acquirer. However, the attribute of being financially strong can be hard to grasp. Piotroski's F-Score addresses this issue as it is a "... composite measure of firm strength" \citep[p. 496]{Fama2006}. It consists of nine binary signals which consider in what directions the fundamentals of a company are trending and whether general health conditions are met \citep{Mohr2012}. \citet{Piotroski2000} established it to separate strong from weak value firms
...
With regards to the above, the F-Score will be used to divide the  sample of investors into strong and weak firms. This separation is done by giving strong firms a score between (7-9) and weak firms a score between (0-3) which is in accordance with the procedure of \citet{Mohr2012}.
...
With the Whited-Wu- and KZ-Index two measurements to distinguish between financially constrained and unconstrained firms are listed. In this case, a firm is financially constrained if it faces an inelastic supply of external capital \citep{Farre-mensa2013}. \citet{Farre-mensa2013} also notes that those firms who are able to raise substantial amounts of external capital without much of an increase in the cost of capital are considered unconstrained. Although \citet{Khatami2014} notes that more recent literature has questioned the reliability of constraint measures, the Whited-Wu- and KZ-Index as defined in \citet{Farre-mensa2013} are used as indicators of financially constrained firms. For both indices firms are sorted into terciles based on their index values. Firms in the top tercile are coded as constrained those in the bottom tercile are coded as unconstrained. This results in 166 constrained and 166 unconstrained firms. 
