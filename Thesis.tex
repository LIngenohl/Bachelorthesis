...
Graph 1 plots the times series of cumulative abnormal returns for the securities of the complete sample, for securities subject to a filing disclosed by a strong and a weak investor. A first glance reveals that the abnormal returns on securities of the complete sample and those with a strong investor evolve almost equally. At around day -7, firms of strong investors start to gain more compared to the total sample. For firms subject to a filing of a weak investor however, the abnormal returns proceed below those of strong investors and the sample and are around 10\% lower during the post announcement period. So for firms that are subject to a filing of a weak investor, abnormal returns are significantly lower when compared to both, abnormal returns of the total sample and those of firms with a strong investor.\\
Notably is the fact that in all three cases, firms' abnormal returns start to aggregate around the [-11,-9] period meaning that information -- in any form -- is available to Schedule 13(D) filers before the filing date. This is matching with \citet[p.1561]{Collin-Dufresne2015} who analyze the trading strategy of Schedule 13(D) filers in the presence of informed trading and find that event dates are clustered during this period based on an increased trading activity in this period. \citet[p.1463]{Collin-Dufresne2015} also note that Schedule 13(D) filers possess valuable and long-lived information on the underlying securities (not available to other market participants) when they trade in the preannouncement period. This means there i a substantial amount of asymmetric information in Schedule 13(D) trades.  Section 13(d) specifies that after passing the 5\% threshold, the investor is obligated to file a Schedule 13(D) within the following 10 days.
