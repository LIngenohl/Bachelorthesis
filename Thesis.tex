\documentclass[12pt]{article}
	...
	% biblatex
	\usepackage[style=authoryear,natbib=true,maxcitenames=2,maxbibnames=11,backend=biber,pagetracker=page,hyperref=true,url=true,doi=true]{biblatex} 
	\usepackage{csquotes}
