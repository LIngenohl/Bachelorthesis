...
\begin{table}[htbp]
	\centering
	\caption{Add caption}
	  \begin{tabular}{rp{5em}p{5em}p{5em}rrp{5em}p{5em}p{5em}rrp{5em}p{5em}p{5em}rrp{5em}p{5em}p{5em}r}
			& \multicolumn{4}{p{20em}}{Abnormal Returns [Days -30,+30]} &       & \multicolumn{4}{p{20em}}{Abnormal Returns [Days -30,+5]} &       & \multicolumn{4}{p{20em}}{Abnormal Returns [Days -10,-4]} &       & \multicolumn{4}{p{20em}}{Abnormal Returns [Days -10,10]} \\
  \cmidrule{2-5}\cmidrule{7-10}\cmidrule{12-15}\cmidrule{17-20}          & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} &       &       & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} &       &       & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} &       &       & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} &  \\
			& Total Sample 
  (1) & Strong Investors
  (2) & Weak Investors
  (3) & \multicolumn{1}{p{5em}}{t-Stat. [Z-stat] for Diff. Between column 2 and 3
  (4)} &       & Total Sample 
  (1) & Strong Investors
  (2) & Weak Investors
  (3) & \multicolumn{1}{p{5em}}{t-Stat. [Z-stat] for Diff. Between column 2 and 3
  ...
  (3) & \multicolumn{1}{p{5em}}{t-Stat. [Z-stat] for Diff. Between column 2 and 3
  (4)} \\
  \cmidrule{2-5}\cmidrule{7-10}\cmidrule{12-15}\cmidrule{17-20}          & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} &       &       & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} &       &       & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} &       &       & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} &  \\
	  \multicolumn{1}{p{5em}}{CAR} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} &       &       & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} &       &       & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} &       &       & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} &  \\
	  \multicolumn{1}{p{5em}}{Mean} & 17.1\%*** & 18.7\%*** & 8.7\%*** & \multicolumn{1}{p{5em}}{11.18 ***} &       & 18.5\%*** & 20.0\%*** & 8.8\% & \multicolumn{1}{p{5em}}{11.6***} &       & 12.5\%*** & 14.2\%*** & 13.4\%*** & 0,43  &       & 15.3\%*** & 17.3\%*** & 14.2\%*** & \multicolumn{1}{p{5em}}{2.44***} \\
	  25\%  & -7.9\% & -0.3\% & \multicolumn{1}{r}{-25\%} &       &       & -5.2\% & -0.5\% & -15.7\% &       &       & -2.8\% & -0.6\% & -2.9\% &       &       & - 4.2\% & 0.6\% & - 6.9\% &  \\
	  50\%  & 12.6\% & 17.9\% & 0.1\% &       &       & 12.1\% & 15.3\% & 2.9\% &       &       & 5.4\% & 6.6\% & 5.4\% &       &       & 8.8\% & 11.8\% & 4.6\% &  \\
	  75\%  & \multicolumn{1}{r}{39,2} & 36.8\% & 27.3\% &       &       & 35.5\% & 36.7\% & 23.3\% &       &       & 20.3\% & 23.8\% & 15.3\% &       &       & 27.4\% & 32.9\% & 21.4\% &  \\
	  \multicolumn{1}{p{5em}}{N} & \multicolumn{1}{r}{489} & \multicolumn{1}{r}{110} & \multicolumn{1}{r}{85} &       &       & \multicolumn{1}{r}{489} & \multicolumn{1}{r}{110} & \multicolumn{1}{r}{85} &       &       & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} &       &       & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} &  \\
	  \multicolumn{1}{p{5em}}{BHAR} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} &       &       & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} &       &       & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} &       &       & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} & \multicolumn{1}{r}{} &  \\
	  \multicolumn{1}{p{5em}}{Mean} & 19.0\%*** & 19.5\%*** & 8.8\%** & \multicolumn{1}{p{5em}}{1.45**} &       & 20.5\%*** & 19.5\%*** & 7.9\% & \multicolumn{1}{p{5em}}{1.67**} &       & 12.9\%*** & 14.2\%*** & 14.2\%*** & 0,01  &       & 16.0\%*** & 17.62\%*** & 13.8\%*** & 0,65 \\
	  25\%  & -7.7\% & 1.5\% & -21.7\% &       &       & -5.1\% & -1.0\% & -16.5\% &       &       & - 2.2\% & - 0.3\% & -2.2\% &       &       & - 4.3\% & 1.0\% & -7.9\% &  \\
	  50\%  & 14.0\% & 15.9\% & 0.5\% &       &       & 12.7\% & 13.2\% & 0.1\% &       &       & 5.0\% & 7.3\% & 3.7\% &       &       & 9.1\& & 11.7\% & 4.3\% &  \\
	  75\%  & 34.6\% & 37.7\% & 19.4\% &       &       & 33.8\% & 35.7\% & 18.5\% &       &       & 19.9\% & 24.4\% & 14.3\% &       &       & 27.3\% & 30.6\% & 18.2\% &  \\
	  \end{tabular}%
	\label{tab:addlabel}%
  \end{table}%
