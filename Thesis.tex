...
\pagenumbering{roman}
\begin{abstract}
\noindent To investigate whether financial constraints of corporate activist investors matter, this thesis is concerned with the relationship between financial constraints of corporate activist investors and target's abnormal returns among a sample of 561 Schedule 13(D) filings disclosed by corporations in the years from 1996-2016 in the United States. By conducting an event study, abnormal share price reactions around the filing date identify the effect the Schedule 13(D) filing has on the target's stock. In fact, estimating abnormal returns via the market model results in average cumulative abnormal returns of 13.3\% for all targets in the event-window [-10,3]. The positive market reaction is consistent with the evidence on the market’s perception that activism results in actual value improvement for the target. Using a variety of financial constraint measures, the investing corporations are classified to be either financially constrained or unconstrained. The univariate analysis shows that targets of financially constrained investors experience significantly lower abnormal returns in response to Schedule 13(D) filings, with average cumulative abnormal returns around 10\% lower in the [-10,3] event window. The multivariate analysis confirms that, other things equal, targets of financially constrained investors experience considerably lower abnormal returns when compared to targets of unconstrained investors. There is a negative relation between financial constraints and the market's perceived value improvement for the target around the filing date of a Schedule 13(D). Although not beyond any doubt, the evidence supports the proposition that financial constraints of corporate activist investors matter. 
\end{abstract}
...
\section{Market Reactions to Schedule 13(D) Filings -- Abnormal Stock Returns}
% Intention
